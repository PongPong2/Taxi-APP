...
function Main_List(): JSX.Element {
  ...
  const [filterdCalls, setFilteredCalls] = useState([]);
  ...
  useEffect(() => {
    const message = messaging().onMessage(remoteMessage => {
      console.log('[Rmotoe Message]', JSON.stringify(remoteMessage));
      requestCallList();
    });
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        refreshControl={
          <RefreshControl refreshing={loding} onRefresh={requestCallList} />
        }
      />

      <Modal transparent={true} visible={loding}>
        <View
